...
// Template
const Command = require('../../structures/Command/Structure');
...
module.exports = class BotInfo extends Command {
  ...
  run({ channel, guild, t, language }) {
    const embed = new Embed(author);

    embed.setAuthor('LenoxBot', guild.me.displayAvatarURL)
        .setThumbnail(guild.me.displayAvatarURL)
        .addField(`⏳ ${t('botinfo_runtime', language)}`, uptimeserver);
