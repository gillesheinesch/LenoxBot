		...
		if (validation.indexOf(margs[i].toLowerCase()) >= 0) {
			if (margs[1].toLowerCase() == 'discordrules') {
				const rules = ['**1.** No spam, advertising or NSFW content! Nobody likes trolls so please do not do that as well.',
					...
					'**5.** Please do not mention team members to get a quicker answer to your question. Direct messages are also included. It\'s much better to ask your question (s) in Public Channel. Most of the time you get a faster answer!',
					'**6.** If your discord name is not easy to mention, please change your nickname to a name that is easier to mark!',
					'**7.** Writing in caps is prohibited',
					'**8.** Disrespectful or offensive messages to a Discord User are prohibited!'
				];
