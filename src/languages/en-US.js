...
module.exports = class extends Language {
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_CLEAR_ERROR: 'You forgot to specify how many messages you want to delete',
			COMMAND_CLEAR_NUMBER: 'The number of messages you want to delete have to be a number!',
			COMMAND_CLEAR_MAXREACHED: 'You can only delete 100 messages at once!',
			COMMAND_CLEAR_MINREACHED: 'You must delete at least 2 messages!',
			COMMAND_CLEAR_SUCCESS: amount => `${amount} messages have been successfully deleted!`,
			...
			COMMAND_REPEAT_NOCHANNEL: 'You need to be in a voice channel to toggle repeating.',
			COMMAND_REPEAT_NOQUEUE: 'The sound of silence is always repeating, please add some music to the queue first!',
			COMMAND_REPEAT_IS: repeat => `Queue repeating has been ${repeat ? '`enabled`' : '`disabled`'}.`,
			...
			MUSIC_STREAMSCANNOTBEREPEATED: 'Streams cannot be repeated.',
			MUSIC_STREAMSCANNOTBELOOPED: 'Streams cannot be looped.',
			MUSIC_STREAMSCANNOTBESHUFFLED: 'Streams cannot be shuffled',
			...
			MUSIC_NOTPAUSED: 'The playback is not paused.',
			MUSIC_UNPAUSED: 'The playback has been resumed.',
			MUSIC_UNPAUSEFAILED: 'The playback has failed to resume.',
			...
			COMMAND_PLAY_DESCRIPTION: 'Searches for audio that matches to your request.',
			COMMAND_PLAY_EXTENDEDHELP: ['play Parkway Drive - Boneyards'].join('\n'),
			COMMAND_LOOP_DESCRIPTION: '(Un)Loop the audio queue.',
			COMMAND_LOOP_EXTENDEDHELP: ['loop'].join('\n'),
			COMMAND_STOP_DESCRIPTION: 'Stops the current audio and the bot leaves the voice channel.',
			COMMAND_STOP_EXTENDEDHELP: ['stop'].join('\n'),
			COMMAND_PAUSE_DESCRIPTION: 'Pause the audio playback.',
			COMMAND_PAUSE_EXTENDEDHELP: ['pause'].join('\n'),
			COMMAND_SKIP_DESCRIPTION: 'Allows the users to skip an audio with a poll.',
			...
			COMMAND_REPEAT_DESCRIPTION: '(Un)Repeat the current audio.',
			COMMAND_REPEAT_EXTENDEDHELP: ['repeat'].join('\n'),
			COMMAND_RESUME_DESCRIPTION: 'Resume the audio playback',
			COMMAND_RESUME_EXTENDEDHELP: ['resume'].join('\n'),
			COMMAND_CLEAR_DESCRIPTION: 'Deletes for you the last X messages that were sent in the current channel',
			COMMAND_CLEAR_EXTENDEDHELP: ['clear 50'].join('\n')
		};
	}
