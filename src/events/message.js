...
// // omfg, what's that :))))) yes as I said it's shit :(())
// module.exports = {
//   run: async (msg) => {
...
const Context = require('../structures/Command/Context');
const { load, t } = require('../utils/Translate');
...
module.exports = class {
  ...
  async run(message) {
    ...
    const context = new Context({
      client: this.client,
      message: message,
      language: client.provider.getGuild(message.guild.id, 'language'),
      prefix: client.provider.getGuild(message.guild.id, 'prefix'),
      t: t
    });
